...
const projectNames = [
    ...
    "TSZvideo", "arc", "clarinet", "discord",
    "hades", "hollowknight", "instruments", "interactiveComic",
    "PB", "photogrammetery", "piano", "raven",
    "truck", "gamification", "beamtours", "commission",
    "fate", "motorpool", "venturecollege",
];
        ...
        portfolio: [
            {
                ...
                description: "My parent's cat shadow",
            },
            {
                image: pjs.dice,
                title: "Metal dice",
                subTitle: "Photography 2023",
                description: "Expermentation with lighting using a set of dice",
            },
            {
                image: pjs.room,
                title: "3D modeled room",
                subTitle: "3D Modeling 2023",
                description: "First experiments with realistic rending in Blender",
            },
            {
                image: pjs.arc,
                title: "Arc reactor",
                subTitle: "3D Modeling 2019",
                description: "Arc reactor I 3D modeled in High School using Inventor",
            },
            {
                image: pjs.clarinet,
                title: "Clarinet shader",
                subTitle: "Blender 2024",
                description: "Model by Blake Hilton",
            },
            {
                image: pjs.discord,
                title: "UX/UI Design",
                subTitle: "UX/UI Design 2022",
                description: "Discord app redesign",
            },
            {
                image: pjs.hades,
                title: "Styx",
                subTitle: "Blender 2023",
                description: "Model, texture, and render of the river Styx",
            },
            {
                image: pjs.hollowknight,
                title: "Book nook",
                subTitle: "Blender 2023",
                description: "First time using Blender. Hollow Knight book nook",
            },
            {
                image: pjs.instruments,
                title: "Instruments shaders",
                subTitle: "Blender 2024",
                description: "Model by Blake Hilton",
            },
            {
                ...
                description: "First experiments with photogrammetery",
            },
            {
                image: pjs.piano,
                title: "Piano shader",
            ...
            },
            {
                ...
                description: "Digital concept art made for a game. Received specifications from game designed and drew concept art from that",
            },
        ]
    }, 
    {
        ...
        portfolio: [
            {
                ...
                description: "Kurikaesu is a VR strategy game I worked on over 6 classes and two years.",
            },
            {
                image: pjs.fortunefire,
                title: "Fortune Fire",
                subTitle: "Competitive blacksmithing game",
                description: "Fortune Fire is a couch co-op competitive blacksmithing game inspired by Plate Up. I created it with a team of 4",
            },
            {
                image: pjs.greentide,
                title: "GreenTide",
                subTitle: "AR tomodachi like game",
                description: "GreenTide is a choose your own adventure AR game inspired by Reigns. I created it in a team of 4 where I was the programmer",
            },
            {
                image: pjs.alexa,
                title: "IOT Alexa App",
                subTitle: "Language learning game through Echo Frames",
                description: "This is a game I created in a group of 4 that is used for language learning through Amazon Echo Frames. We created an Alexa app for echo frames inspired by the game Shiritori",
            },
            {
                image: pjs.TSZvideo,
            ...
            },
            {
                ...
                subTitle: "First game and first time coding",
                description: "This was my first game ever, my first time programming, my first time animating, and my first time doing digital art.",
            },
        ]
    }, 
    {
        ...
        `,
        p3: `
            My strengths lie more in team leadership and product management roles, rather than project management and timelines. While I have no issues meeting deadlines, I believe my talents shine more as a principled engineer. I enjoyed my leadership roles and found great value in mentoring new hires for the GIMM Works team, an experience that benefited both myself and the new team members.
        `,
        ...
        portfolio: [
            {
                ...
                description: "I was the team lead for creating an escape room in the Stein Luminary at Boise State University.",
            },
            {
